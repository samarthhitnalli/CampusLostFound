            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-success text-white">
                        <h4><i class="bi bi-check-circle"></i> Report Found Item</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="found-item" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="itemName" class="form-control" 
                                       placeholder="e.g., Silver Watch, Red Umbrella" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="location" class="form-control" 
                                       placeholder="e.g., Basketball Court, CS Department" required>
                            </div>
                            
                            <div class="mb-3">
                                <label class="form-label">Date Found *</label>
                                <input type="date" name="foundDate" class="form-control" 
...
<h2><i class="bi bi-check-circle"></i> Report Found Item</h2>
<p class="mb-0">Help reunite lost items with their owners</p>
</div>
...
<h4 class="mb-0"><i class="bi bi-plus-circle"></i> Found Item Details</h4>
</div>
...
<form action="found-item" method="post" enctype="multipart/form-data">
...
<input type="text" name="location" class="form-control"
placeholder="e.g., Library, CSE Block" required>
</div>
...
<button type="submit" class="btn btn-success">
<i class="bi bi-check-circle"></i> Submit Found Item
</button>
<a href="user-dashboard.jsp" class="btn btn-secondary">Cancel</a>
</div>
