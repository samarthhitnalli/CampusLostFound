...
<%@ page import="com.campus.model.User, com.campus.model.LostItem, com.campus.dao.LostDAO, java.util.List" %>
<%
    ...
    if (keyword != null || location != null || date != null) {
        items = lostDAO.searchLostItems(keyword, location, date);
    } else {
        items = lostDAO.getAllLostItems();
    }
%>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>View Lost Items - Campus Lost and Found</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="user-dashboard.jsp"><i class="bi bi-search"></i> Campus Lost and Found</a>
    ...
    <div class="container mt-4">
        <h2><i class="bi bi-exclamation-circle text-danger"></i> Lost Items</h2>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="get" action="view-lost.jsp">
                    <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p><strong>Date Lost:</strong> <%= item.getLostDate() %></p>
                                <p><strong>Contact:</strong> <%= item.getContact() %></p>
                                <p><strong>Reported by:</strong> <%= item.getUserName() %></p>
                                <span class="badge <%= "resolved".equals(item.getStatus()) ? "bg-success" : "bg-warning" %>">
                                    <%= item.getStatus().toUpperCase() %>
                                </span>
                            </div>
                            <% if (item.getUserId() == user.getUserId() && "lost".equals(item.getStatus())) { %>
                                <div class="card-footer">
                                    <form action="lost-item" method="post" class="d-inline">
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>View Lost Items - Campus Lost & Found</title>
...
<h2><i class="bi bi-exclamation-circle"></i> Lost Items</h2>
<p class="mb-0">Browse items reported lost across the campus</p>
</div>
...
<i class="bi bi-info-circle"></i> No lost items found.
</div>
</div>
<% } else {
for (LostItem item : items) { %>
...
<%= "resolved".equals(item.getStatus()) ? "bg-success" : "bg-warning text-dark" %>">
<%= item.getStatus().toUpperCase() %>
</span>
</div>
